package com.br.intranexti.views.cadastrodeativos;
...
@PageTitle("Cadastro de Ativos")
@Route(value = "cadastroativo", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@RolesAllowed("ADMIN")
@Uses(Icon.class)
public class CadastrodeAtivosView extends Composite<VerticalLayout> {

    public CadastrodeAtivosView() {
